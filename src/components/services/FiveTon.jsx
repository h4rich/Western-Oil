...
const FiveTon = () => {
  const images = [overrig4, overrig5];
    ...
    <div className="w-full px-6 py-10 md:px-16 bg-gray-300">
      ...
      >
        <h1 className="text-3xl md:text-5xl font-bold text-gray-900 mb-4">
          50 TON WORK OVER RIG
        </h1>
        <p className="text-gray-700 text-base md:text-lg leading-relaxed">
          We have 1 Nos. W OFS - 05 of Mobile Work over Rigs with a capacity of
          50 Tons, working at various projects like ONGC and many more
        </p>
      </motion.div>
