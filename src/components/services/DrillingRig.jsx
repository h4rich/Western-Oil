...
const DrillingRig = () => {
  const images = [drilling]; // Right now only 1 image
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start gap-10">
        ...
        >
          ...
          <p className="text-gray-600 text-base md:text-lg leading-relaxed">
            ...
            Drilling up to a depth of 3500 meters. Our advanced rigs ensure high
            efficiency and safety standards, making them suitable for a variety
